...
/*   Updated: 2022/11/18 13:17:28 by maolivei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap &ClapTrap::operator=(ClapTrap const &rhs)
{
    ...
    const_cast<std::string &>(this->_type) = "ClapTrap";
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    this->_hitPoints += amount;
    std::cout << this->_type << " " << this->_name
              << " repaired itself, gaining " << amount
              << " hit points, and now has " << this->_hitPoints << " hit point"
              << (this->_hitPoints != 1 ? "s" : "") << " in total!"
              << std::endl;
}
...
{
    std::cout << "Cannot perform action, " << this->_type << " " << this->_name
